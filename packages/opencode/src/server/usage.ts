...
const ANTIGRAVITY_GROUPS = ["claude", "gemini-3-flash", "gemini-3-pro"]
...
async function refreshToken(refresh: string) {
  ...
  // Don't persist the refreshed token - keep this ephemeral
  // Let the opencode-anthropic-auth plugin handle token persistence during inference calls
